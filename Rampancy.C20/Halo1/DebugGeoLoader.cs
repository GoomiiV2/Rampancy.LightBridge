            ...
            try {
                ...
                foreach (var srcLine in lines) {
                    ...
                    if (line.StartsWith("Coordinate3", ignoreCase)) {
                        ...
                        currentItem.Color = new Vector4(float.Parse(colors[1].Value), float.Parse(colors[2].Value), float.Parse(colors[3].Value), 1f - float.Parse(colors[4].Value));
                    }
                        ...
                        // Try and name
                        if (currentItem.Color.X == 255 && currentItem.Color.Y == 0 && currentItem.Color.Z == 0 && currentItem.Flags == DebugGeoMarker.ItemFlags.Tri) {
